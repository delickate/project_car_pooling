    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a hef="<?php echo base_url('/dashboard'); ?>">
                        Dashboard
                    </a>
                </div>
                <div class="navi">
                    <ul>
                        <li class="active"><a href="<?php echo base_url('/dashboard'); ?>"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Dashboard</span></a></li>
                        <li><a href="<?php echo base_url('/locationcontroller/index'); ?>"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Locations</span></a></li>
                        <li><a href="<?php echo base_url('/vehicletypecontroller/index'); ?>"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Vehicle Types</span></a></li>
                        <li><a href="<?php echo base_url('/ridedetailcontroller/index'); ?>"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Rides</span></a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-md-5">
                            <div class="header-rightside">
                                <ul class="list-inline header-top pull-right">
                                    <li class="hidden-xs">
                                    	<a href="<?php echo base_url('authcontroller/logout'); ?>" class="add-project" data-toggle="modal" data-target="#add_project">Logout</a>
                                    </li>
